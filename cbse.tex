...
\item In \figref{fig:figure2}, $PQ$ is a chord of length $8 cm$ of a circle of radius $5 cm$ and centre $O$. The tangents at $P$ and $Q$ intersect at point $T$. Find the length of $TP$.
\begin{figure}[H]                                             \centering
         \includegraphics[width=\columnwidth]{figs/i2.jpg}
			...
			\label{fig:figure2}
                ...
                \end{figure}
	\item In \figref{fig:figure3}, angle $ACB = 90^\degree$  and $CDAB$, prove that $CD ^ 2 = BDAD$ .
\begin{figure}[H]                                                            \centering
...
\item Find the area of the shaded region in \figref{fig:figure4}, if $ABCD$ is a rectangle with sides $8 cm$ and $6 cm$ and $O$ is the centre of circle. (Taken = $3.14$)
	\begin{figure}[H]                                     \centering
